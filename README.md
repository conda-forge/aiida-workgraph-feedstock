About aiida-workgraph-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/aiida-workgraph-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aiida-workgraph-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add aiida-workgraph
# for installing globally
pixi global install aiida-workgraph
```
...
It is possible to list all of the versions of `aiida-workgraph` available on your platform:
...
```
pixi search aiida-workgraph --channel conda-forge
```
